...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="../js/registroclientes.js"></script>
                                                ...
                                                <div class="row">
                                                    <div class="span6">
                                                        ...
                                                        <div class="control-group">                                         
                                                            ...
                                                            <div class="controls">
                                                                <input type="hidden" name="cupo_credito" id="cupo_credito" class="span4" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea name="notas_cli" id="notas_cli" rows="3" class="span4" style="display:none"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <section class="columna2">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <select name="tipo_cli" id="tipo_cli" required class="span4" style="display:none">
                                                                    <option value="">......Seleccione......</option>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="hidden" name="directores" id="directores" required class="span4" placeholder="Buscar..." />
