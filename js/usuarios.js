...
function inicio() {
    ...
    jQuery("#list").jqGrid({
        ...
        colModel: [
            ...
            {name: 'apellido_usuario', index: 'apellido_usuario', editable: true, align: 'center', width: '140', search: true, frozen: true},
            ...
            {name: 'celular_usuario', index: 'celular_usuario', editable: true, align: 'center', width: '140', search: false, editoptions:{maxlength: 10, size:20,dataInit: function(elem){$(elem).bind("keypress", function(e) {return numeros(e)})}}}, 
