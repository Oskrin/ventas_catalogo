                ...
                <ul>
                    ...
                    <li><a href="" >Compras</a>
                        <ul>
                            ...
                            <li><a href="">Devolución Compra</a></li>
                        </ul>
                    </li>
                    <li><a href="" target="_parent">Ventas</a>
                        <ul>
                            <li><a href="">Ventas facturación</a></li>
                    ...
                    <li><a href="">Registro Gastos</a></li>
                    <li><a href="">Gastos Internos</a></li>
                </ul>
            </li>
                    ...
                    <li>
                        ...
                        <div style="width:400px;max-width:100%;">
                            <div style="padding:1px 10px;">
                              <li><a href="" id="">Respaldo de la base de datos</a></li>     
                            </div>
                        </div>
                    </li>
                </ul>
